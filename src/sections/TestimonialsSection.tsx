...
export function TestimonialsSection() {
  ...
  const testimonials = [
    {
      client: 'Lisbeth (España)',
      quote:
        'Este proceso me ha permitido avanzar y romper los paradigmas que tenia, Gracias César, has sido un gran aliado para mi, cada una de tus palabras ha entrado en mi mente, haciendola cambiar para siempre.',
      change: 'Transformación mental y personal',
    },
    {
      client: 'Marilyn (Venezuela)',
      quote:
        'César despierta tus sentidos, la fuerza, la actitud y convicción en ti son tangibles. Para mi, contar con César, ha sido vital en este proceso de reprogramacion mental, emocional y espiritual. ',
      change: 'Reprogramacion mental, emocional y espiritual',
    },
  ];
      ...
      <div className='container mx-auto px-6 md:px-20 max-w-7xl relative z-10'>
        ...
        <div className='text-center max-w-3xl mx-auto mb-20'>
          ...
          <p className='font-hanken text-base md:text-lg text-on-surface-variant font-light'>
            Empresarios y profesionales que decidieron desmantelar sus patrones
            limitantes para operar desde su máximo potencial mental.
          </p>
        </div>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center'>
          ...
          {/* Right Column: Premium Video Testimonial Player (7 Columns) */}
          <div className='lg:col-span-7'>
            <div className='relative border border-gold/20 p-2 bg-surface-container-lowest overflow-hidden aspect-video flex items-center justify-center'>
              {isPlaying ? (
                <video
                  src='/assets/videos/testimonio-carla-de-la-vega.mp4'
                  controls
                  autoPlay
                ...
                >
                  ...
                  <div className='absolute bottom-6 left-6 z-10 font-hanken text-left'>
